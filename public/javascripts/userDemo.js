...
var functionsDomain = 'https://us-central1-o2oproject-8d54b.cloudfunctions.net/widgets';
// var functionsDomain = 'http://localhost:5000/o2oproject-8d54b/us-central1/widgets';
    	...
    	var docId = '';
		    ...
		    if (found) {
					db.collection("users").doc(docId).update({
					  state: 'win',
					  couponLink: 'https://rmarepo.richmediaads.com/o2o/demo/en/coupon.html'
					})
					.then(() => {
						 resolve({
							data: {
